...
\begin{center}\begin{tabular}{llll}\toprule Rhyme & Tibetan & GX input & GHC \\\midrule
...
GX merges each pair, so automatic GX conversion defaults to R.79/R.92. The backslash is a converter-only input extension that explicitly requests R.101/R.100. Sources: \href{https://homepage.univie.ac.at/xun.gong/tangut/phonology-202409.html}{Gong Xun, Tangut phonology} and \href{https://semakosa.github.io/tangut-pronunciation-db/docs/GX202411-zh.html}{GX202411}.
\end{document}
