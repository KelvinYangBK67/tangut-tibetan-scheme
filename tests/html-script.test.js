...
assert.match(home, /<script src="converter\.js\?v=xunpin-input-20260811"><\/script>/u);
assert.match(home, /GX／勳拼 → 藏文/u);
assert.match(home, /ShangguSans-Bold-core\.woff2\?v=shanggu-web-v2/u);
assert.match(home, /shanggu-web\.css\?v=shanggu-web-v2/u);
...
assert.match(scheme, /shanggu-web\.css\?v=shanggu-web-v2/u);
