...
assert.match(home, /data\/tangut-tibetan\.csv\?v=fallback-20260812/u);
...
assert.match(home, /ShangguSans-Bold-core\.woff2\?v=shanggu-web-v6/u);
assert.match(home, /shanggu-web\.css\?v=shanggu-web-v6/u);
...
assert.match(scheme, /shanggu-web\.css\?v=shanggu-web-v6/u);
