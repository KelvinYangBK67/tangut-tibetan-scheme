...
assert.match(home, /<script src="converter\.js\?v=ra-20260820"><\/script>/u);
...
assert.match(home, /data\/tangut-tibetan\.csv\?v=ra-20260820/u);
...
assert.match(home, /ShangguSans-Bold-core\.woff2\?v=shanggu-web-v8/u);
assert.match(home, /shanggu-web\.css\?v=shanggu-web-v8/u);
...
assert.doesNotMatch(scheme, /v-, y-, r-|fixed-form/u);
assert.doesNotMatch(schemeEn, /v-, y-, r-|fixed forms when actual initials/u);
assert.match(scheme, /rur¹、rer¹、rir¹、rar¹/u);
assert.match(schemeEn, /rur¹, rer¹, rir¹, rar¹/u);
...
assert.match(scheme, /shanggu-web\.css\?v=shanggu-web-v8/u);
